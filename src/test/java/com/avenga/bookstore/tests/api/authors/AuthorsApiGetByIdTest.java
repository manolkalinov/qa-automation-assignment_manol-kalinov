...
public class AuthorsApiGetByIdTest extends BaseApiTest {
    ...
    public void verifyGetByIdSuccessful() {
        ...
        var response = bookstoreClient.retrieveAuthorById(1);
    ...
    public void verifyGetByIdValidNotFound() {
        ...
        var response = bookstoreClient.retrieveAuthorById(999999);
    ...
    public void verifyGetByIdInvalidZero() {
        ...
        var response = bookstoreClient.retrieveAuthorById(0);
        assertThat(response.statusCode()).isEqualTo(404);
        assertThat(response.body()).isNull();
    }
    ...
    public void verifyGetByIdInvalidMalformed() {
        ...
        var response = bookstoreClient.retrieveAuthorById("babayaga");
