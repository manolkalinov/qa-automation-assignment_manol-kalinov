...
public class AuthorsApiDeleteTest extends BaseApiTest {
    ...
    public void verifyDeleteSuccessful() {
        ...
        var response = bookstoreClient.deleteAuthor(1);
    ...
    public void verifyDeleteValidNotFound() {
        ...
        var response = bookstoreClient.deleteAuthor(999999);
        assertThat(response.statusCode()).isEqualTo(200);
        assertThat(response.body()).isNull();
    }
    ...
    public void verifyDeleteInvalidId() {
        ...
        var responseZero = bookstoreClient.deleteAuthor(0);
        var responseNegative = bookstoreClient.deleteAuthor(-1);
    ...
    public void verifyDeleteInvalidMalformed() {
        ...
        var response = bookstoreClient.deleteAuthor("babayaga");
